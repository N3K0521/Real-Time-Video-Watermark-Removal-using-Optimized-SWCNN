...
def water_test_video():
    ...
    while cap.isOpened():
        ...
        # Print CPU and GPU utilization
        cpu_usage = psutil.cpu_percent()
        gpu_usage = torch.cuda.memory_allocated(0) / torch.cuda.max_memory_allocated(0) * 100
        print(f"CPU Usage: {cpu_usage:.2f}% | GPU Usage: {gpu_usage:.2f}%")

        # Store CPU and GPU usage for average calculation
    ...
    # Calculate and print average CPU and GPU usage
